export default class EntityDataReader {

  /**
   * @param entity 实体名称
   * @param lazy 是否懒加载，默认为是
   * @param fields e.g. 'name,code'
   * @param params e.g. {provinceCode: 'gs:$ctx.form.province'}，该信息会自动加入计算属性中，当province的值变动时，该数据源会重新加载计算
