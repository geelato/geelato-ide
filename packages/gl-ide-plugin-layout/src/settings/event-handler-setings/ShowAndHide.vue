  ...
  <div>
    <table class="gl-table">
      ...
      <tr class="gl-table-row">
        ...
        <td class="gl-table-cell">
          <a-radio-group value="show" size="small">
            <a-radio-button value="show">显示</a-radio-button>
            <a-radio-button value="hidden">隐藏</a-radio-button>
            <a-radio-button value="toggle">切换</a-radio-button>
          </a-radio-group>
          <a-alert
              message="切换：若当前为显示状态则变为隐藏，若当前为隐藏状态则变为显示"
              banner
              type="info"
          />
        </td>
...
<script>
  ...
  export default {
    ...
    beforeDestroy() {
      this.$emit('update', this.displayInfo)
    },
    methods: {}
  }
</script>
